      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white dark:bg-[#121215] p-8 rounded-xl border border-zinc-200 dark:border-zinc-800/90 shadow-xl dark:shadow-2xl">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">Create Account</h2>
            <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1 font-sans">Get personalized AI interview prep kits</p>
          </div>
